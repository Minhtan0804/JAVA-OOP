...
public class Wage implements Comparable<Wage> {
    ...
    public Wage(String fullName, int dailySalary, int workDays, String position) {
    ...
    public int compareTo(Wage o) {
        return this.realSalary < o.realSalary ? 1 : -1;
    }
